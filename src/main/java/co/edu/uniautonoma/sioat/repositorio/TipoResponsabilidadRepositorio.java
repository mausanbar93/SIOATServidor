/**
 * TipoResponsabilidadRepositorio.java
 * 
 * Creada el 28/10/2017, 11:36:08 AM
 * 
 ...
 * @date 28/10/2017
 */
public interface TipoResponsabilidadRepositorio extends CrudRepository<TipoResponsabilidad, Integer> {
